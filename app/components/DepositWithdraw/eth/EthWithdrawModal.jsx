...
import {validateAddress, WithdrawAddresses} from "common/EthMethods";
...
class EthWithdrawModal extends React.Component {
    static propTypes = {
    ...
    render() {
        ...
        let amountBalance =
            ...
            10 ** this.props.asset.get("precision");
        let maxAmount = utils.format_number(
            amountBalance < this.props.max_amount
                ? amountBalance
        ...
        /*
        maxAmount = utils.format_number(
            current < this.props.max_amount ? current: this.props.max_amount, //this.props.max_amount,
            this.props.asset_precision,
            false
        );
        */
...
export default BindToChainState(EthWithdrawModal, {keep_updating: true});
