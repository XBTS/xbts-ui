...
import EthWithdrawModal from "./EthWithdrawModal";
import AccountBalance from "../../Account/AccountBalance";
import EthDepositAddressCache from "lib/common/EthDepositAddressCache";
import {requestDepositAddress} from "lib/common/EthMethods";
...
class EthGatewayDepositRequest extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        super(props);
        this.deposit_address_cache = new EthDepositAddressCache();
...
export default BindToChainState(EthGatewayDepositRequest, {
    keep_updating: true
});
