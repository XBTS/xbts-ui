...
import EosWithdrawModal from "./EosWithdrawModal";
import AccountBalance from "../../Account/AccountBalance";
import EosDepositAddressCache from "lib/common/EosDepositAddressCache";
import {requestDepositAddress} from "lib/common/EosMethods";
...
class EosGatewayDepositRequest extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        super(props);
        this.deposit_address_cache = new EosDepositAddressCache();
    ...
    render() {
        ...
        if (this.props.deposit_account) {
            ...
            if (receive_address.memo) {
                // This is a client that uses a deposit memo (like HT Eco Chain), we need to display both the address and the memo they need to send
                    ...
                    <div className="small-12 medium-7">
                        ...
                        <div style={{padding: "10px 0", fontSize: "1.1rem"}}>
                            ...
                            <Translate
                                className="has-error fz_14"
                                component="p"
                                content="gateway.eos.min_deposit_warning_asset"
                                minDeposit={minDeposit}
                                coin={this.props.deposit_asset}
                            />
                        </div>
...
export default BindToChainState(EosGatewayDepositRequest, {
    keep_updating: true
});
