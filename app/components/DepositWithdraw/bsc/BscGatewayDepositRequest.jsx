...
import BscWithdrawModal from "./BscWithdrawModal";
import AccountBalance from "../../Account/AccountBalance";
import BscDepositAddressCache from "lib/common/BscDepositAddressCache";
import {requestDepositAddress} from "lib/common/BscMethods";
...
class BscGatewayDepositRequest extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        super(props);
        this.deposit_address_cache = new BscDepositAddressCache();
...
export default BindToChainState(BscGatewayDepositRequest, {
    keep_updating: true
});
