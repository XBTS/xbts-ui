...
import {validateAddress, WithdrawAddresses} from "common/BscMethods";
...
class BscWithdrawModal extends React.Component {
    static propTypes = {
...
BscWithdrawModal = BindToChainState(BscWithdrawModal);

export default connect(BscWithdrawModal, {
    listenTo() {
