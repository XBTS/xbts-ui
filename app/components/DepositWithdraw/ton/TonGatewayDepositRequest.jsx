...
import TonWithdrawModal from "./TonWithdrawModal";
import AccountBalance from "../../Account/AccountBalance";
import TonDepositAddressCache from "lib/common/TonDepositAddressCache";
import {requestDepositAddress} from "lib/common/TonMethods";
...
class TonGatewayDepositRequest extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        super(props);
        this.deposit_address_cache = new TonDepositAddressCache();
...
export default BindToChainState(TonGatewayDepositRequest, {
    keep_updating: true
});
