...
import TonGatewayDepositRequest from "./TonGatewayDepositRequest";
...
class TonGateway extends React.Component {
    ...
    onSelectCoin(e) {
        ...
        let setting = {};
        setting[`activeCoin_ton_${this.state.action}`] = e.target.value;
    ...
    changeAction(type) {
        ...
        SettingsActions.changeViewSetting({["tonAction"]: type});
    }
...
export default connect(TonGateway, {
    listenTo() {
