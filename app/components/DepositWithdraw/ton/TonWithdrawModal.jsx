...
import {validateAddress, WithdrawAddresses} from "common/TonMethods";
...
class TonWithdrawModal extends React.Component {
    static propTypes = {
...
TonWithdrawModal = BindToChainState(TonWithdrawModal);

export default connect(TonWithdrawModal, {
    listenTo() {
